...
def process_one_image_pair_debug(image_name,clean_folder,noise_folder,clean_t,noise_t, severity=1):
    ...
    denoised_image_nl1 = nl_denoising(cur_noise_image, h=10)
    denoised_image_nl2 = nl_denoising(cur_noise_image, h=18)
    # denoised_image_nl3 = nl_denoising(cur_noise_image, h=20)
    denoised_image_nl4 = nl_denoising(cur_noise_image, h=25)
    # denoised_image_nl5 = nl_denoising(cur_noise_image, h=30)
    # denoised_image_nl6 = nl_denoising(cur_noise_image, h=35)
    denoised_image_nl7 = nl_denoising(cur_noise_image, h=40)

    # img_pair_all = np.hstack([cur_clean_image, cur_noise_image, denoised_image_mean,denoised_image_median,denoised_imag_gaussian,denoised_image_bil,denoised_image_nl, denoised_image_bm3d])
    img_pair_all = np.hstack([denoised_image_nl1,denoised_image_nl2,denoised_image_nl4, denoised_image_nl7])
